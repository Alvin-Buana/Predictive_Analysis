...
### Solution statements
Untuk menyelesaikan masalah ini, saya akan mengajukan 3 solusi machine learning model yang sederhana karena data ini merupakan data klasifikasi non-linear. Berikut adalah penjelasan model-model machine learning yang akan digunakan untuk masalah ini. :
